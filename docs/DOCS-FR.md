...
JavaScript v9 est en cours : 149 blocs FR sur 230 (1311/1311 fichiers) — modules 1-12 **100 % complets**. JavaScript v9 **100 % terminé** (230/230). Prochaine priorité produit : Vague 5 (SRS, XP, PWA…) après fiabilité.
