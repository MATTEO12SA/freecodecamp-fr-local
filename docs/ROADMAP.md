...
- État curriculum : JavaScript v9 `204/230` (1195/1311 fichiers), modules 1 à 12 complets.
...
2. onboarding du premier lancement (**fait** : `LocalOnboarding`) ;
3. export/import du profil local (**fait** : `local-profile` + Dev FR) ;
