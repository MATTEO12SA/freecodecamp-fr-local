...
- État curriculum : JavaScript v9 `126/230` (535/1311 fichiers), modules 1 à 8 complets ; module 9
  `dom-manipulation-and-events` à 8/12. Prochaine cible : relire
  `workshop-rps-game` (`reviewed: false` — ne pas appliquer).
