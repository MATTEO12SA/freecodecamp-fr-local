...
RWD est terminé (158/158). JavaScript v9 est en cours : 149 blocs FR sur 230 (1195/1311 fichiers) — modules 1-12 **100 % complets**. Prochaine cible : extraire/traduire `tools/translations/lecture-understanding-graphs-and-trees-js.json` (`reviewed: false` — ne pas appliquer).
