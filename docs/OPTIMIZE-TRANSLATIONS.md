...
RWD est terminé (158/158). JavaScript v9 est en cours : 149 blocs FR sur 230 (649/1311 fichiers) — modules 1-12 **100 % complets**. Prochaine cible : relire `tools/translations/lecture-understanding-form-validation.json` (`reviewed: false` — ne pas appliquer).
