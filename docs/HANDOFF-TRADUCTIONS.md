...
### JavaScript v9 — Dates terminé (159/230)

État actuel : 155 blocs FR sur 230 (757/1311 fichiers, ~58 %). Modules 1–12 + form-validation + dates **100 %**. Prochaine cible : relire `tools/translations/lecture-working-with-audio-and-video.json` (module audio/vidéo, `reviewed: false` — **ne pas appliquer**).
...
Suite en cours : JavaScript v9 (159/230 blocs, 757/1311 fichiers). Modules 1–12 + form-validation **100 %**. Pipeline gere lectures, workshops/labs, reviews (mode lecture + `# --assignment--`) et quizzes (`kind: "quiz"`). Prochaine cible : relire `lecture-working-with-audio-and-video` (`reviewed: false` — ne pas appliquer).
...
- [tools/translation-status.js](../tools/translation-status.js) : pour chaque `*-v9.json`, compte les blocs FR existants / total et dessine une barre ASCII. JS = 159/230.
...
3. Continuer JavaScript v9 : modules 1–12 + form-validation **100 %** (159/230) ; prochaine cible = relire `lecture-working-with-audio-and-video` (`reviewed: false` — ne pas appliquer).
...
JS v9 à 159/230 (757/1311). Module dates traduit. Prochaine cible : `lecture-working-with-audio-and-video.json` (`reviewed: false`).

**Dernière session (2026-08-20, form-validation + Continuer)** :
JS v9 à 159/230 (757/1311). Module form-validation : lecture, workshop-calorie-counter
...
JS v9 à 159/230 blocs (757/1311 fichiers), modules 1-12 **100 %**. Modules 10–11
