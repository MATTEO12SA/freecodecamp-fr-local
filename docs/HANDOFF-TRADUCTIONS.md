...
### JavaScript v9 — Form-validation terminé (155/230)

État actuel : 155 blocs FR sur 230 (752/1311 fichiers, ~57 %). Modules 1–12 + form-validation **100 %**. Prochaine cible : relire `tools/translations/lecture-working-with-dates.json` (module dates, `reviewed: false` — **ne pas appliquer**).
...
Suite en cours : JavaScript v9 (155/230 blocs, 752/1311 fichiers). Modules 1–12 + form-validation **100 %**. Pipeline gere lectures, workshops/labs, reviews (mode lecture + `# --assignment--`) et quizzes (`kind: "quiz"`). Prochaine cible : relire `lecture-working-with-dates` (`reviewed: false` — ne pas appliquer).
...
- [tools/translation-status.js](../tools/translation-status.js) : pour chaque `*-v9.json`, compte les blocs FR existants / total et dessine une barre ASCII. JS = 155/230.
...
3. Continuer JavaScript v9 : modules 1–12 + form-validation **100 %** (155/230) ; prochaine cible = relire `lecture-working-with-dates` (`reviewed: false` — ne pas appliquer).
...
JS v9 à 155/230 (752/1311). Module form-validation : lecture, workshop-calorie-counter
...
JS v9 à 155/230 blocs (752/1311 fichiers), modules 1-12 **100 %**. Modules 10–11
