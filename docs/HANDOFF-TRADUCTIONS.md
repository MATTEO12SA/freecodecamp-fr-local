...
### JavaScript v9 — Module 12 Terminé (150/230)

État actuel : 149 blocs FR sur 230 (649/1311 fichiers, ~50 %). Les modules 1-12 sont **100 % traduits**. Prochaine cible : relire `tools/translations/lecture-understanding-form-validation.json` (projet cert markdown, `reviewed: false` — **ne pas appliquer**).
...
Suite en cours : JavaScript v9 (150/230 blocs, 649/1311 fichiers). Modules 1-12 **100 % complets**. Pipeline gere lectures, workshops/labs, reviews (mode lecture + `# --assignment--`) et quizzes (`kind: "quiz"`). Prochaine cible : relire `lecture-understanding-form-validation` (`reviewed: false` — ne pas appliquer).
...
- [tools/translation-status.js](../tools/translation-status.js) : pour chaque `*-v9.json`, compte les blocs FR existants / total et dessine une barre ASCII. JS = 150/230.
...
3. Continuer JavaScript v9 : modules 1-12 **100 % complets** (150/230) ; prochaine cible = relire `lecture-understanding-form-validation` (`reviewed: false` — ne pas appliquer).
...
JS v9 à 150/230 blocs (649/1311 fichiers), modules 1-12 **100 %**. Modules 10–11
