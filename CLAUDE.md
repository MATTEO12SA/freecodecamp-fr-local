...
- **JavaScript v9** : 164/230 blocs, 812/1311 fichiers — modules 1-12 **100 % complets**. Prochaine cible : relire `tools/translations/lecture-working-with-maps-and-sets.json` (`reviewed: false` — ne pas appliquer). Le pipeline gère lectures, workshops/labs, reviews et quizzes.
