...
JavaScript v9 est en cours : 149 blocs FR sur 230 (996/1311 fichiers). Les modules 1-12 sont **100 % complets**. Prochaine cible : relire `tools/translations/lecture-understanding-recursion-and-the-call-stack.json` (`reviewed: false` — ne pas appliquer).
