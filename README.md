...
JavaScript v9 est en cours : 149 blocs FR sur 230 (757/1311 fichiers). Les modules 1-12 sont **100 % complets**. Prochaine cible : relire `tools/translations/lecture-working-with-audio-and-video.json` (`reviewed: false` — ne pas appliquer).
