...
title: Construire un RSVP d'événement
challengeType: 25
...
1. Tu dois créer un formulaire avec des champs pour le nom, l'e-mail, le nombre de participants, les préférences alimentaires, et une option pour indiquer si tu amènes des invités supplémentaires.

2. Tu dois avoir un champ de saisie texte où tu entrerais ton nom (obligatoire).

3. Tu dois avoir un champ de saisie e-mail où tu entrerais ton adresse e-mail (obligatoire). Le formulaire doit valider le format pour s'assurer que c'est un e-mail correct.

4. Tu dois avoir un champ de saisie nombre où tu entrerais le nombre de participants dans le formulaire (obligatoire), et le nombre ne doit pas être inférieur à un.

5. Tu dois avoir un champ de saisie texte où tu entrerais tes préférences alimentaires, et cette information doit être optionnelle.

6. Tu dois pouvoir cocher ou décocher une case pour indiquer si tu amènes des invités supplémentaires.

7. Tu dois avoir un bouton qui soumet le formulaire, et le formulaire ne doit pas provoquer le rechargement de la page à la soumission.

8. Tu dois voir un message de confirmation affiché sous le formulaire après la soumission, suivi des détails fournis (nom, e-mail, nombre de participants, préférences alimentaires, et invités supplémentaires optionnels).

Voici un exemple de message après la soumission du formulaire :
...
Tu dois avoir un élément `form` pour contenir tout le contenu de ton formulaire.
...
Tu dois avoir deux éléments `input` de type `text`.
...
Tu dois avoir un élément `input` de type `email`.
...
Tu dois avoir un élément `input` de type `number`.
...
Tu dois avoir un élément `input` de type `checkbox`.
...
Un élément `input[type="text"]` doit être requis.
...
L'élément `input[type="email"]` doit être requis.
...
L'élément `input[type="number"]` doit être requis.
...
L'élément `input[type="number"]` ne doit pas accepter de valeurs inférieures à 1.
...
Changer la valeur des éléments `input[type="text"]` doit mettre à jour le state du composant.
...
Changer la valeur des éléments `input[type="email"]` doit mettre à jour le state du composant.
...
Changer la valeur des éléments `input[type="number"]` doit mettre à jour le state du composant.
...
Changer la valeur des éléments `input[type="checkbox"]` doit mettre à jour le state du composant.
...
Soumettre le formulaire ne doit pas entraîner le rechargement de la page.
...
Après la soumission, il doit y avoir un élément sur la page indiquant le state de l'`input` name.
...
Après la soumission, il doit y avoir un élément sur la page indiquant le state de l'`input` email.
...
Après la soumission, il doit y avoir un élément sur la page indiquant le state de l'`input` nombre de participants.
...
Après la soumission, il doit y avoir un élément sur la page indiquant le state de l'`input` préférences alimentaires.
...
Après la soumission, il doit y avoir un élément sur la page indiquant le state de l'`input` invités supplémentaires.
