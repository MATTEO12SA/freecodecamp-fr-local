...
Maintenant, tu sais que le bouton fonctionne. Retire l'instruction `console.log` de la fonction `displayStory`.

# --hints--

Tu devrais retirer l'instruction `console.log` de la fonction `displayStory`.
