...
Sous l'élément `.btn-container`, tu devrais avoir un élément `p` avec l'`id` `result`. C'est là que l'histoire s'affichera.

# --hints--

Tu devrais avoir un élément `p` avec l'`id` `result`.
