...
Sélectionne les boutons `#scary-btn`, `#funny-btn` et `#adventure-btn` et stocke-les dans des variables appelées `scaryStoryBtn`, `funnyStoryBtn` et `adventureStoryBtn`.

# --hints--

Tu devrais sélectionner le bouton `#scary-btn` avec la méthode `getElementById` et le stocker dans la variable `scaryStoryBtn`.
...
Tu devrais sélectionner le bouton `#funny-btn` avec la méthode `getElementById` et le stocker dans la variable `funnyStoryBtn`.
...
Tu devrais sélectionner le bouton `#adventure-btn` avec la méthode `getElementById` et le stocker dans la variable `adventureStoryBtn`.
