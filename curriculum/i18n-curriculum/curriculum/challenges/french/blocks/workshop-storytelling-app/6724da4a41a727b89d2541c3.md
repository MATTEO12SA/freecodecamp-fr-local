...
Maintenant que la fonction `displayStory` fonctionne correctement, il est temps d'ajouter le comportement aux boutons.

Avant cela, retire l'appel de fonction `displayStory("scary")`.

# --hints--

Tu devrais retirer l'appel de fonction `displayStory("scary")`.
