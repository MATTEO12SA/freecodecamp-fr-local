...
Pour distinguer les différents types d'histoires, tu devras passer le genre de l'histoire sélectionnée à la fonction `displayStory`.

Ajoute un paramètre appelé `genre` à la fonction `displayStory`.

# --hints--

Tu devrais ajouter le paramètre `genre` à la fonction `displayStory`.
