...
Ajoute un nouveau sélecteur `#piano` dans ta requête `@media`, et définis `width` sur `358px`.

# --hints--

Ta règle `@media` devrait avoir un sélecteur `#piano`.
...
Ton nouveau sélecteur `#piano` devrait avoir une propriété `width` de `358px`.
