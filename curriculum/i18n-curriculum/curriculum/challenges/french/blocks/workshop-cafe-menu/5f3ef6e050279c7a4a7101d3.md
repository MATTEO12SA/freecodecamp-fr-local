...
C'est mieux. Maintenant essayez d'ajouter la même `20px` rembourrage vers le haut et le bas du menu.

# --hints--

Vous ne devriez pas retirer le `padding-left` ou `padding-right` propriétés.
...
Vous devriez mettre le `padding-top` propriété `20px`.
...
Vous devriez mettre le `padding-bottom` propriété `20px`.
...
Votre `.menu` élément devrait avoir un `padding-top` des `20px`.
...
Votre `.menu` élément devrait avoir un `padding-bottom` des `20px`.
