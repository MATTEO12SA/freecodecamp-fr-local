...
En se concentrant sur les éléments de menu et les prix, il y a un écart assez important entre chaque ligne.

Utilisez le sélecteur existant qui cible tous les `p` éléments imbriqués dans des éléments avec la classe nommée `item` et de fixer leur marge supérieure et inférieure à `5px`.

# --hints--

Vous devriez mettre le `margin-top` propriété `5px`.
...
Vous devriez mettre le `margin-bottom` propriété `5px`.
...
Vous devriez utiliser le `.item p` sélecteur.
...
Votre `p` éléments imbriqués dans votre `.item` les éléments devraient avoir une `margin-top` des `5px`.
...
Votre `p` éléments imbriqués dans votre `.item` les éléments devraient avoir une `margin-bottom` des `5px`.
...
Votre `p` éléments imbriqués dans votre `.item` les éléments ne devraient pas `margin-left` Prêt.
...
Votre `p` éléments imbriqués dans votre `.item` les éléments ne devraient pas `margin-right` Prêt.
