...
Alignez maintenant le texte sur le `right` pour les éléments avec le `price` En cours.

# --hints--

Vous devriez avoir un `price` sélecteur de classe.
...
Votre `price` sélecteur de classe doit définir le `text-align` propriété `right`.
