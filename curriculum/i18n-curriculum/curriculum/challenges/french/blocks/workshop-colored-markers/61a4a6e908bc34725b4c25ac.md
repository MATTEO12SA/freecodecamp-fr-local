...
Ensuite, définis l’arrêt de couleur du rouge sur `0%`, l’arrêt de couleur du vert sur `50%` et l’arrêt de couleur du bleu sur `100%`.

# --hints--

Ta règle CSS `.red` devrait avoir une propriété `background` définie sur `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`.
