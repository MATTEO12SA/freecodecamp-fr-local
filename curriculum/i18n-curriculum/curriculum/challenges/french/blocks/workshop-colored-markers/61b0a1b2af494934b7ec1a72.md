...
Parfait. Ton marqueur rouge a belle allure. Il ne te reste plus qu’à ajouter les capuchons et les manchons aux autres marqueurs.

Ajoute un capuchon et un manchon aux marqueurs vert et bleu. Tu peux simplement copier les éléments `div` du marqueur rouge et les coller dans les deux autres marqueurs.

# --hints--

Ton `div` de marqueur vert devrait contenir deux éléments `div`.
...
L'élément `div` du capuchon de ton marqueur vert devrait être avant l'élément `div` du manchon.
...
Ton `div` de marqueur bleu devrait contenir deux éléments `div`.
...
L'élément `div` du capuchon de ton marqueur bleu devrait être avant l'élément `div` du manchon.
