...
Encore une fois, utilise le composant `Card` deux fois de plus avec ce qui suit :

| Props  | Valeurs première carte | Valeurs deuxième carte |
|-------|------------------------------------------------------------|-----------------------------------------------------|
| `name`  | `"Tiffany"` | `"Doug"`|
...
Tu ne dois pas modifier le composant `Card` existant dans ton composant `App`.
...
Tu dois utiliser le composant `Card` comme élément avec les props appropriées et les valeurs de la première carte.
...
Tu dois utiliser le composant `Card` comme élément avec les props appropriées et les valeurs de la deuxième carte.
