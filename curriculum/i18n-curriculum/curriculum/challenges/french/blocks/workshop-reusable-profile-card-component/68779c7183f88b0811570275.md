...
Ajoute deux objets de plus au tableau `profiles` — un pour Tiffany et un pour Doug :
...
Ta logique `map()` doit rester inchangée et afficher maintenant les trois cartes.

Avec ça, ton projet de composant de carte de profil réutilisable est terminé !

# --hints--

Tu dois afficher exactement trois composants `Card`.
