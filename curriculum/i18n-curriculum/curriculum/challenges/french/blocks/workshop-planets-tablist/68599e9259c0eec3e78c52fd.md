...
Par défaut, les autres onglets ne devraient pas être sélectionnés. Tu peux le faire en ajoutant l'attribut `aria-selected` aux deuxième et troisième éléments `button` et en définissant leurs valeurs à `"false"`.

# --hints--

Ton deuxième élément `button` devrait avoir un attribut `aria-selected`.
...
Ton deuxième élément `button` devrait avoir un attribut `aria-selected` défini à `"false"`.
...
Ton troisième élément `button` devrait avoir un attribut `aria-selected`.
...
Ton troisième élément `button` devrait avoir un attribut `aria-selected` défini à `"false"`.
