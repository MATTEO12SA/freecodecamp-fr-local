...
Il est maintenant temps d'ajouter les faits pour chaque planète. À l'intérieur du premier élément `p`, ajoute le texte suivant :
...
À l'intérieur du deuxième élément `p`, ajoute le texte suivant :
...
À l'intérieur du troisième élément `p`, ajoute le texte suivant :
...
Ton premier élément `p` devrait contenir les faits sur Earth. Assure-toi que ton texte correspond à la description fournie.
...
Ton deuxième élément `p` devrait contenir les faits sur Saturn. Assure-toi que ton texte correspond à la description fournie.
...
Ton troisième élément `p` devrait contenir les faits sur Mars. Assure-toi que ton texte correspond à la description fournie.
