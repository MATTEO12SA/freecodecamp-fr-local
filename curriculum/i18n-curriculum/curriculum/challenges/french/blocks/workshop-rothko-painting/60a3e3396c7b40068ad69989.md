...
Remplace le `background-color` de `.three` par `#b20403`.

# --hints--

Tu devrais définir la propriété `background-color` sur `#b20403`.
...
Ton élément `.three` devrait avoir la propriété `background-color` avec la valeur `#b20403`.
