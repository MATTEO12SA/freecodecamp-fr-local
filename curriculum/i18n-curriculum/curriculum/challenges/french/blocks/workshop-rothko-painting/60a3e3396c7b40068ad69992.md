...
Les coins de chaque rectangle sont encore trop nets.

Arrondis chaque coin de l’élément `.one` de 9 pixels avec la propriété `border-radius`.

# --hints--

Tu devrais définir la propriété `border-radius` sur `9px`.
...
Ton élément `.one` devrait avoir la propriété `border-radius` avec la valeur `9px`.
