...
Définis maintenant la `height` de `.one` sur 150 pixels.

# --hints--

Tu devrais définir la propriété `height` sur `150px`.
...
Ton élément `.one` devrait avoir la propriété `height` avec la valeur `150px`.
