...
Sur le sujet de l'accessibilité visuelle, le contraste entre les éléments est un facteur clé. Par exemple, le contraste entre le texte et l'arrière-plan d'un titre doit être d'au moins 4.5:1.

Change la couleur de police de tous les éléments d'ancre dans les éléments de liste pour quelque chose avec un ratio de contraste d'au moins 7:1.

# --hints--

Ton sélecteur doit cibler les liens à l’intérieur des éléments de liste.
...
Les éléments `a` dans les éléments de liste doivent avoir une propriété `color`.
...
Tu dois seulement changer la couleur des éléments `a` dans les éléments de liste.
...
Tu dois donner à la propriété `color` un contraste avec l'arrière-plan d'au moins 7:1. _Indice : j'utiliserais `#dfdfe2`_
