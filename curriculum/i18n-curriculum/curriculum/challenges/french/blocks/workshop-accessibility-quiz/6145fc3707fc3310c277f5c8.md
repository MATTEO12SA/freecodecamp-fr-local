...
Retour au style de la page. Sélectionne les éléments de liste dans la barre de navigation, et donne-leur les styles suivants :
...
Tu dois utiliser soit le sélecteur `nav li`, soit le sélecteur `nav > ul > li`.
...
Les éléments `li` doivent avoir une propriété `color` de `#dfdfe2`.
...
Les éléments `li` doivent avoir une propriété `margin` de `0 0.2rem`.
...
Les éléments `li` doivent avoir une propriété `padding` de `0.2rem`.
...
Les éléments `li` doivent avoir une propriété `display` de `block`.
