...
Sur les petits écrans, la liste non ordonnée dans la barre de navigation déborde sur le côté droit de l'écran.

Corrige cela en utilisant _Flexbox_ pour permettre au contenu du `ul` de passer à la ligne. Ensuite, définis les propriétés CSS suivantes pour aligner correctement le texte :
