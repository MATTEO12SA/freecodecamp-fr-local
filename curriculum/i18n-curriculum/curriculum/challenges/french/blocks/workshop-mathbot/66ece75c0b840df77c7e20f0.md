...
Pour la dernière étape du workshop, tu afficheras le message `"It was fun learning about the different Math methods with you!"` dans la console.

Et avec ce dernier changement, tu as terminé le workshop MathBot !

# --hints--

Tu devrais afficher le message `"It was fun learning about the different Math methods with you!"` dans la console.
