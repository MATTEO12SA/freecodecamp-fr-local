...
Enfin, appelle `genParentheses` avec `3` comme argument pour générer les cinq combinaisons valides de trois paires de parenthèses et affiche le résultat dans la console.

Avec cela, ton atelier de parcours en largeur est terminé.

# --hints--

Tu dois afficher `genParentheses(3)`.
