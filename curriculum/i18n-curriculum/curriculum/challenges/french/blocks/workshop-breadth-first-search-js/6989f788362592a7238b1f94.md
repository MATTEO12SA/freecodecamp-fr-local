...
Maintenant tu n'as plus besoin d'afficher la file. Donc retire `console.log(queue)` de ta boucle `while`.

# --hints--

Tu ne dois pas avoir `console.log(queue)` dans ta boucle `while`.
