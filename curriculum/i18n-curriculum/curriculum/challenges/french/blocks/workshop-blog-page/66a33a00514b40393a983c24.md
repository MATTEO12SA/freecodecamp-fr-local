...
Pour le troisième post du blog, tu vas devoir ajouter un autre élément `article`.

À l'intérieur de l'élément `article`, ajoute un élément `h3` avec le texte `Mr. Whiskers' First Birthday Party`.

Sous ton élément `h3`, ajoute deux paragraphes de texte lorem ipsum.

# --hints--

Tu devrais avoir un troisième élément `article` à l'intérieur de ton élément `section` avec l'`id` mis à `posts`.
...
Tu devrais avoir un élément `h3` à l'intérieur de l'élément `article` avec le texte `Mr. Whiskers' First Birthday Party`.
...
Tu devrais avoir deux éléments paragraphe à l'intérieur de l'élément `article`.
...
Ton premier élément paragraphe devrait avoir du texte lorem ipsum. Vérifie bien l'orthographe et la ponctuation. 
...
Ton deuxième élément paragraphe devrait avoir du texte lorem ipsum. Vérifie bien l'orthographe et la ponctuation. 
...
Tes paragraphes devraient venir après l'élément `h3`.
