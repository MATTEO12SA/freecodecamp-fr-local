...
Pour le deuxième post du blog, tu vas devoir ajouter un autre élément `article`.

À l'intérieur de l'élément `article`, ajoute un élément `h3` avec le texte `Mr. Whiskers' First Bath`.

Sous ton élément `h3`, ajoute deux paragraphes de texte lorem ipsum.

# --hints--

Tu devrais avoir un deuxième élément `article` à l'intérieur de ton élément `section` avec l'`id` mis à `posts`.
...
Tu devrais avoir un élément `h3` à l'intérieur de l'élément `article` avec le texte `Mr. Whiskers' First Bath`.
