...
Pour cette étape, tu vas devoir ajouter le numéro de téléphone et l'adresse email de l'auteur du blog.

À l'intérieur de l'élément `address`, ajoute un élément paragraphe avec le texte `Phone: 555-555-5555`.

Sous cet élément paragraphe, ajoute un autre élément paragraphe avec le texte `Email: fake@email.com`.

# --hints--

Tu devrais avoir deux éléments `p` à l'intérieur de ton élément `address`.
...
Ton premier élément `p` devrait avoir le texte `Phone: 555-555-5555`.
...
Ton deuxième élément `p` devrait avoir le texte `Email: fake@email.com`.
