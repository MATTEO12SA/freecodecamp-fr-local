...
De la même façon, les utilisateurs devraient pouvoir cliquer sur l'adresse email et envoyer un email depuis leur client de messagerie par défaut.

Voici comment tu peux rendre les adresses email cliquables :

```html
<a href="mailto:contact@company.com">contact@company.com</a>
```

Pour cette dernière étape, entoure le texte `fake@email.com` d'un élément d'ancrage et utilise `mailto:` pour en faire une adresse email cliquable.

Et avec ces changements, ta page de blog est maintenant complète.

# --hints--

Tu devrais envelopper le texte `fake@email.com` dans un élément `a`.
...
Ton élément `a` devrait avoir un attribut `href`.
...
L'attribut `href` de ton nouvel élément `a` devrait être mis à `mailto:fake@email.com`.
