...
À l'intérieur de l'élément `footer`, ajoute un élément `section` avec un `id` mis à `contact`.

À l'intérieur de l'élément `section`, ajoute un élément `h2` avec le texte `Contact`.

# --hints--

Tu devrais avoir un élément `section` à l'intérieur de ton élément `footer`.
...
Ton élément `section` devrait avoir un `id` mis à `"contact"`.
...
Tu devrais avoir un élément `h2` à l'intérieur de ton élément `section`.
...
Ton élément `h2` devrait avoir le texte `Contact`.
