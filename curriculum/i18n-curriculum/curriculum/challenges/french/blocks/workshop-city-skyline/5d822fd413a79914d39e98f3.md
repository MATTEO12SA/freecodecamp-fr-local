...
Tu n'as plus besoin des propriétés `height` ou `background-color` dans `.bb1a`, `.bb1b` ou `.bb1c`, donc supprime-les.

# --hints--

Tu devrais supprimer le `background-color` de `.bb1a`.

```js
assert.isEmpty(new __helpers.CSSHelp(document).getStyle('.bb1a')?.backgroundColor);
```

Tu devrais supprimer la propriété `height` de `.bb1b`.

```js
assert.isEmpty(new __helpers.CSSHelp(document).getStyle('.bb1b')?.height);
```

Tu devrais supprimer la propriété `background-color` de `.bb1b`.

```js
assert.isEmpty(new __helpers.CSSHelp(document).getStyle('.bb1b')?.backgroundColor);
```

Tu devrais supprimer la propriété `height` de `.bb1c`.

```js
assert.isEmpty(new __helpers.CSSHelp(document).getStyle('.bb1c')?.height);
```

Tu devrais supprimer la propriété `background-color` de `.bb1c`.
