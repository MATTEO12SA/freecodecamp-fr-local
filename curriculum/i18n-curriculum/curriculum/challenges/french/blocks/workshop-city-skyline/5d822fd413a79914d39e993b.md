...
Copie-colle toute ta classe `sky`, avec toutes ses propriétés et valeurs, dans la media query. Tu vas créer un autre jeu de couleurs pour le skyline, qui le fera passer du jour à la nuit.

Note : tu devras faire defiler au-dela de la zone modifiable pour copier la classe.

# --hints--

Tu ne devrais pas supprimer la déclaration `.sky` existante.
...
Tu devrais copier la déclaration `.sky` existante dans la media query.
