...
Ajoute un sélecteur `:root` au début de ta media query. Ensuite, redéfinis les quatre variables `--building-color` pour qu'elles utilisent toutes la valeur `#000`.

# --hints--

Tu devrais ajouter un sélecteur `:root` à la media query.
...
Tu devrais ajouter `--building-color1` avec une valeur de `#000`.
...
Tu devrais ajouter `--building-color2` avec une valeur de `#000`.
...
Tu devrais ajouter `--building-color3` avec une valeur de `#000`.
...
Tu devrais ajouter `--building-color4` avec une valeur de `#000`.
