...
Dans la classe `sky` de la media query, change les deux valeurs de couleur `#ffcf33` en `#ccc`, le `#ffff66` en `#445`, et le `#bbeeff` en `#223`. Ensuite, tu peux redimensionner ta fenêtre pour voir l'arrière-plan changer de couleurs.

# --hints--

Tu devrais changer les premières valeurs de couleur de `#ffcf33` à `#ccc`.
...
Tu devrais changer la deuxième valeur de couleur de `#ffff66` à `#445`.
...
Tu devrais changer la troisième valeur de couleur de `#bbeeff` à `#223`.
