...
Resserre à nouveau les immeubles en ajoutant deux éléments `div` vides au début et à la fin de l'élément `.foreground-buildings`, puis un autre entre `.fb2` et `.fb3`.

# --hints--

Tu devrais ajouter deux éléments `div` comme premiers enfants de `.foreground-buildings`.
...
Tu devrais ajouter un élément `div` entre `.fb2` et `.fb3`.
...
Tu devrais ajouter deux éléments `div` comme derniers enfants de `.foreground-buildings`.
...
Tu devrais avoir ajoute 5 nouveaux éléments `div`.
