...
Crée un sélecteur `.calories-info h2` et retire tous les margins.

# --hints--

Crée un sélecteur `.calories-info h2`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.calories-info h2'));
```

Ton sélecteur `.calories-info h2` devrait avoir un `margin` défini sur `0`.
