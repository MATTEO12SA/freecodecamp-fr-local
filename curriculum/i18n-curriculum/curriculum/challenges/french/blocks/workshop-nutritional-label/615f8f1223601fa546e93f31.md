...
Crée le dernier élément `p` de ta section `.daily-value`. Donne-lui le texte `Potassium 235mg 6%`. Aligne le texte `6%` à droite, et retire la bordure du bas de l'élément `p`.
...
Ton nouvel élément `p` devrait avoir le texte `Potassium 235mg 6%`.
