...
Crée un autre élément `p` après ton dernier `.divider`, et donne-lui le texte `Total Sugars 12g`. Attribue à cet élément `p` les valeurs de `class` nécessaires pour l'indenter et retirer la bordure du bas. Crée ensuite un autre `.divider` sous ton nouvel élément `p`.
...
Ton nouvel élément `p` devrait avoir le texte `Total Sugars 12g`.
