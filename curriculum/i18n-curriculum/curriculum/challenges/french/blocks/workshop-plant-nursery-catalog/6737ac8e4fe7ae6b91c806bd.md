...
Toujours dans ta fonction, ajoute l'objet `prettyPolly` à ton set.

# --hints--

Tu dois utiliser la méthode `add` pour ajouter l'objet `prettyPolly` à ton set dans la fonction `displayPlantsSet`.
