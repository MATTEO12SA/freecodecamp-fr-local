...
Maintenant, modifie ton appel à `removePlant` en lui passant l'objet `ballerina` et regarde la console. Tu verras une erreur que tu vas corriger à l'étape suivante.
