...
Toujours à l'intérieur de la fonction `playSong`, définis la propriété `audio.src` égale à `song.src`. Cela indique à l'élément audio où trouver les données audio de la chanson sélectionnée.

Définis aussi la propriété `audio.title` égale à `song.title`. Cela indique à l'élément audio quoi afficher comme titre de la chanson.

# --hints--

Tu devrais définir la propriété `audio.src` égale à `song.src` à l'intérieur de ta fonction `playSong`.
...
Tu devrais définir la propriété `audio.title` égale à `song.title` à l'intérieur de ta fonction `playSong`.
