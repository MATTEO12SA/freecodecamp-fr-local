...
Maintenant, utilise l'opérateur **OR** pour ajouter le paramètre `start` comme deuxième condition à l'instruction `if` après `userData.currentSong === null`.


# --hints--

Tu devrais utiliser l'opérateur **OR** pour ajouter le paramètre `start` comme deuxième condition à l'instruction `if` après `userData.currentSong === null`.
