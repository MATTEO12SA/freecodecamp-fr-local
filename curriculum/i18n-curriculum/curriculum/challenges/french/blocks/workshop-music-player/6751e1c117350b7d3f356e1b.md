...
À l'intérieur de la fonction `playSong`, appelle la fonction `highlightCurrentSong`.

Ensuite, joue avec les boutons de contrôle pour voir comment la fonction `highlightCurrentSong` fonctionne.

# --hints--

Tu devrais appeler `highlightCurrentSong` à l'intérieur de la fonction `playSong`.
