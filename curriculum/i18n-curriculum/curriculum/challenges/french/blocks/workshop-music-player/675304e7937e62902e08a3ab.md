...
Maintenant, appelle la fonction `setPlayButtonAccessibleText` à l'intérieur de la fonction `playSong`.

# --hints--

Tu devrais appeler la fonction `setPlayButtonAccessibleText` à l'intérieur de la fonction `playSong`.
