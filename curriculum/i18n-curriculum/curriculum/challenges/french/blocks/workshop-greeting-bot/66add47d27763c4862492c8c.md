...
Pour la dernière étape, tu vas afficher le message du bot `"Well, it was nice to talk to you. Have a nice day!"` dans la console.

Et avec ça, ton bot de salutation est terminé !
...
Ton instruction `console` devrait afficher la chaîne `"Well, it was nice to talk to you. Have a nice day!"`.
