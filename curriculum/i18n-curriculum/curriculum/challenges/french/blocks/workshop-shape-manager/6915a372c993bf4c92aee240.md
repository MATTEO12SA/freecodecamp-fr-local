...
Maintenant, crée une fonction `initializeApp` et laisse-la vide pour l’instant.

Cela initialisera toute l’app une fois le DOM chargé. C’est donc la fonction que tu passeras bientôt à un événement `DOMContentLoaded` qui fera fonctionner l’app.

# --hints--

Tu dois créer une fonction `initializeApp`.
