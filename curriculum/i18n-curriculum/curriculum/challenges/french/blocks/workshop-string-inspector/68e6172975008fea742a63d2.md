...
Pour finir, ajoute une instruction `console.log()` avec le message : `"Workshop complete! You now know how to use includes() and slice()."`

Félicitations ! Tu as terminé le workshop String Inspector.

# --hints--

Tu devrais afficher `"Workshop complete! You now know how to use includes() and slice()."` dans la console.
