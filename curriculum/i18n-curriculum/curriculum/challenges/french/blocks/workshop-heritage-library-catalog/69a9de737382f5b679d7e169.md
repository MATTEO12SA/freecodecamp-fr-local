...
Pour trouver les auteurs correspondants, vérifie chaque entrée du catalogue une par une.

Ajoute une boucle `for` vide à l'intérieur de `findByAuthor` pour itérer sur `catalog`. Tu ajouteras le corps de la boucle à l'étape suivante.
