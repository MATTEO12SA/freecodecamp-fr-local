...
Comme mentionné plus tôt, quand l'utilisateur édite la note puis clique à l'extérieur, un message devrait s'afficher pour indiquer que la note a été enregistrée.

Pour y arriver, définis `statusEl.textContent` à la chaîne `"Note saved successfully!"`.

Maintenant, quand tu testes, tu devrais voir ce message s'afficher à l'écran.

# --hints--

Quand l'utilisateur édite une note, le message d'état devrait être mis à jour pour indiquer que la note a été enregistrée.
