...
Une fois que tu as le contenu édité, ce sera désormais le contenu actuel.

À l'intérieur de l'écouteur d'événement, assigne `newContent` à `currentContent`.

# --hints--

Tu devrais assigner `newContent` à `currentContent` à l'intérieur de l'écouteur d'événement.
