...
D'abord, affiche le message suivant dans la console : `"\nProcessing " + gate.id + "..."`.

# --hints--

Ta fonction `handleGateAtTick` doit d'abord afficher le message suivant dans la console, `"\nProcessing " + gate.id + "..."`.
...
Ta fonction `handleGateAtTick` doit afficher le bon ID de porte dans le message.
