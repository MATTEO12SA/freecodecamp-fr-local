...
Ensuite, tu as besoin d'un moyen de suivre combien de participants sont traités par la porte pendant le tick. Crée une variable nommée `processed` et initialise-la à `0`.

# --hints--

Tu dois créer une variable nommée `processed` et lui affecter la valeur `0`.
