...
Ensuite, affiche le message suivant dans la console : `gate.queue[tickIndex] + " attendees arriving."`.

# --hints--

Ta fonction `handleGateAtTick` doit afficher le message suivant dans la console : `gate.queue[tickIndex] + " attendees arriving."`.
...
Ta fonction `handleGateAtTick` doit afficher le bon nombre de participants en fonction de la file de la porte au tickIndex donné.
