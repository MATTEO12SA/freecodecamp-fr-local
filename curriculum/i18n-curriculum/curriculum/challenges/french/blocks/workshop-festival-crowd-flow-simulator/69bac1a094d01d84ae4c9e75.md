...
Pour garder la trace du tick en cours de traitement pendant la simulation, crée une variable nommée `tickIndex` et affecte-lui une valeur initiale de `0`.

Cette variable sera utilisée pour parcourir tous les ticks de ta simulation et garantir que chaque porte est traitée dans le bon ordre.

# --hints--

Tu dois créer une variable nommée `tickIndex` et lui affecter la valeur `0`.
