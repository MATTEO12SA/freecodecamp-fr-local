...
Pour que les éléments `input` et `textarea` se fondent dans le thème de fond, définis leur `background-color` sur `#0a0a23`. Ensuite, donne-leur une bordure de `1px`, `solid`, avec une couleur de `#0a0a23`.

# --hints--

Tu dois utiliser un sélecteur d'éléments séparés par des virgules pour sélectionner les éléments `input` et `textarea`.
...
Tu dois donner aux éléments `input` et `textarea` un `background-color` de `#0a0a23`.
...
Tu dois donner aux éléments `input` et `textarea` une bordure de `1px`, `solid`, avec une couleur de `#0a0a23`.
