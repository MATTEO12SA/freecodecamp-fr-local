...
Si tu regardes d'assez près, tu remarqueras que les éléments `.inline` sont trop hauts sur la ligne.

Pour corriger cela, définis la propriété `vertical-align` sur `middle`.

# --hints--

Tu dois définir la propriété `vertical-align` sur `middle` pour tous les éléments `.inline`.
