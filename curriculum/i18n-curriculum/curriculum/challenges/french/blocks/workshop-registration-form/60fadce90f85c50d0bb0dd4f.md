...
Pour donner aux éléments `fieldset` un peu de séparation, sélectionne-les et donne-leur une `border-bottom` de `3px solid #3b3b4f`.

# --hints--

Tu dois donner aux éléments `fieldset` une `border-bottom` de `3px solid #3b3b4f`.
