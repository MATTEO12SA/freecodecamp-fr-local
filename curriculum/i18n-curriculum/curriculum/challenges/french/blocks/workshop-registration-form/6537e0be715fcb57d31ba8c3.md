...
Enfin, change la couleur du texte de l'élément de lien `terms and conditions` en `#dfdfe2` en ajoutant un nouveau sélecteur dans le CSS.

Bravo ! Tu as terminé la dernière partie du workshop _Registration Form_.

# --hints--


Tu dois donner à l'élément `a` une `color` de `#dfdfe2`.
