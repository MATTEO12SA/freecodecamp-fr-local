...
L'élément `figure` représente un **contenu autonome** : il sert à grouper une image avec sa légende (par exemple).

Imbrique l'image que tu viens d'ajouter dans un élément `figure`.
...
L'élément `figure` doit se trouver juste au-dessus de la balise fermante du deuxième `section`.
