...
N'oublie pas d'ajouter l'attribut `selected` à l'élément `option` avec la valeur `"excellent"`.
...
Ton `option` avec la `value` de `"poor"` doit avoir le texte `"Poor"`.
...
Ton `option` avec la `value` de `"satisfactory"` doit avoir le texte `"Satisfactory"`.
...
Ton `option` avec la `value` de `"good"` doit avoir le texte `"Good"`.
...
Ton `option` avec la `value` de `"very-good"` doit avoir le texte `"Very Good"`.
...
Ton `option` avec la `value` de `"excellent"` doit avoir le texte `"Excellent"`.
...
Tu dois avoir un élément `option` avec l'attribut `selected` défini sur `"excellent"`.
