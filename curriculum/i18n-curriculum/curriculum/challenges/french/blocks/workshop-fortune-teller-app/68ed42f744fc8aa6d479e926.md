...
Ajoute maintenant les propriétés restantes à l’objet privé `elements`. Ce sont : `multipleCard`, `title`, `newReadingBtn`, `fortuneContainer`, `fortuneDescription`, `headerTitle`, `subTitle`, `cardTitle`, `description` et `text`. Assure-toi que chaque propriété utilise le type `HTMLElement`.

# --hints--

Tu dois avoir la propriété `multipleCard` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `title` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `newReadingBtn` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `fortuneContainer` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `fortuneDescription` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `headerTitle` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `subTitle` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `cardTitle` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `description` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
...
Tu dois avoir la propriété `text` à l’intérieur de la propriété `elements` avec le type `HTMLElement`.
