...
Vérifie si `cardElement` n’est pas une instance de `HTMLElement`, et dans ce cas, ajoute un `return`

# --hints--

Tu dois ajouter une autre instruction `if` avec la condition `!(cardElement instanceof HTMLElement)`.
