...
À l’intérieur de la classe, ajoute une propriété privée `elements` sous forme d’objet. À l’intérieur, ajoute les propriétés `singleCardBtn`, `singleCard` et `multipleCardsBtn`, chacune typée comme `HTMLElement`.

# --hints--

Tu dois déclarer une propriété `private` nommée `elements` à l’intérieur de la classe `Game`.
...
Ta propriété privée `elements` doit avoir une propriété `singleCardBtn` typée comme `HTMLElement`.
...
Ta propriété privée `elements` doit avoir une propriété `multipleCardsBtn` typée comme `HTMLElement`.
...
Ta propriété privée `elements` doit avoir une propriété `singleCard` typée comme `HTMLElement`.
