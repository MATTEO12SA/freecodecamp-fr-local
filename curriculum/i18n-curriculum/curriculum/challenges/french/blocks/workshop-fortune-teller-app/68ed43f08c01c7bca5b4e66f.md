...
Fais maintenant la même chose pour le reste des propriétés. Utilise la fonction `getElement` pour sélectionner chacune :
...
Tu dois accéder à `multipleCardsBtn` en utilisant la méthode `getElement` et en passant `#btn-multiple-cards`.
...
Tu dois accéder à `multipleCard` en utilisant la méthode `getElement` et en passant `.multiple_card`.
...
Tu dois accéder à `title` en utilisant la méthode `getElement` et en passant `.title`.
...
Tu dois accéder à `newReadingBtn` en utilisant la méthode `getElement` et en passant `.btn_reveal`.
...
Tu dois accéder à `fortuneContainer` en utilisant la méthode `getElement` et en passant `.fortune_container`.
...
Tu dois accéder à `fortuneDescription` en utilisant la méthode `getElement` et en passant `.fortune_description`.
...
Tu dois accéder à `headerTitle` en utilisant la méthode `getElement` et en passant `.header_title`.
...
Tu dois accéder à `subTitle` en utilisant la méthode `getElement` et en passant `.sub_title`.
...
Tu dois accéder à `cardTitle` en utilisant la méthode `getElement` et en passant `.desc_title`.
...
Tu dois accéder à `description` en utilisant la méthode `getElement` et en passant `.description`.
...
Tu dois accéder à `text` en utilisant la méthode `getElement` et en passant `.text`.
