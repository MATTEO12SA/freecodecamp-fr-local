...
Tu vas maintenant commencer à travailler sur la méthode `initializeEventListeners()`. D’abord, donne-lui le type de retour `void`.

# --hints--

Ta méthode `initializeEventListeners` doit avoir un type de retour `void`.
