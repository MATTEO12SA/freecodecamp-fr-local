...
title: Concevoir une exposition de photographie
challengeType: 25
...
Dans ce lab, tu vas créer une disposition d'exposition de photographie en utilisant les classes utilitaires de Tailwind CSS.

Pour les images, tu peux utiliser les URL suivantes si tu le souhaites :
...
1. Tu dois avoir un élément avec une classe appelée `main-container`.
2. Ton élément `.main-container` doit aussi avoir les classes utilitaires Tailwind CSS suivantes :
   - la bonne classe utilitaire pour créer un conteneur CSS Grid.
   - une classe utilitaire pour définir le nombre de colonnes dans la grille. Tu dois utiliser la classe utilitaire qui utilise un nombre fixe de colonnes. Ex. `grid-cols-<number>`.
   - une classe utilitaire pour définir l'écart (gap) en ligne et en colonne pour les éléments de la grille.
3. À l'intérieur de ton élément `.main-container`, il doit y avoir au moins trois éléments, chacun avec une classe appelée `card`.
4. Chacun de tes éléments `.card` doit aussi avoir les classes utilitaires Tailwind CSS suivantes :
   - une classe utilitaire pour définir une bordure arrondie de ton choix.
   - une classe utilitaire pour définir un padding de ton choix. Tu dois utiliser ce format `p-<number>`.
5. À l'intérieur de chacun de tes éléments `.card`, tu dois avoir les éléments suivants :
   - un élément image avec des attributs `src` et `alt`.
   - un élément avec la classe appelée `subheading`.
   - un élément avec la classe appelée `description`.
6. Chacun de tes éléments image doit avoir une classe utilitaire pour définir une bordure arrondie de ton choix.
7. Chacun de tes éléments `.subheading` doit utiliser des classes utilitaires pour définir le poids et la taille de police de ton choix.
8. Chacun de tes éléments `.description` doit utiliser une classe utilitaire pour définir la taille de police de ton choix.

# --hints--

Tu dois avoir un élément avec une classe appelée `main-container`.

```js
assert.exists(document.querySelector(".main-container"));
```

Ton élément `.main-container` doit utiliser la bonne classe utilitaire Tailwind CSS pour créer un conteneur CSS Grid.
...
Ton élément `.main-container` doit utiliser une classe utilitaire pour définir le nombre de colonnes dans la grille.
...
Ton élément `.main-container` doit utiliser une classe utilitaire pour définir l'écart (gap) en ligne et en colonne pour les éléments de la grille.
...
Ton élément `.main-container` doit contenir au moins trois éléments, chacun avec une classe appelée `card`.
...
Chacun de tes éléments `.card` doit avoir une classe utilitaire pour définir une bordure arrondie.
...
Chacun de tes éléments `.card` doit avoir une classe utilitaire pour définir le padding.
...
Chacun de tes éléments `.card` doit contenir un élément image.
...
Chacun de tes éléments `img` doit avoir un attribut `src`.
...
Chacun de tes éléments `img` doit avoir un attribut `alt`.
...
Chacun de tes éléments `.card` doit contenir un élément avec la classe appelée `subheading`.
...
Chacun de tes éléments `.subheading` doit avoir un contenu texte.
...
Chacun de tes éléments `.card` doit contenir un élément avec la classe appelée `description`.
...
Chacun de tes éléments `.description` doit avoir un contenu texte.
...
Chacun de tes éléments `img` doit avoir une classe utilitaire pour définir une bordure arrondie.
...
Chacun de tes éléments `.subheading` doit utiliser des classes utilitaires pour définir le poids de police.
...
Chacun de tes éléments `.subheading` doit utiliser des classes utilitaires pour définir la taille de police.
...
Chacun de tes éléments `.description` doit utiliser une classe utilitaire pour définir la taille de police.
