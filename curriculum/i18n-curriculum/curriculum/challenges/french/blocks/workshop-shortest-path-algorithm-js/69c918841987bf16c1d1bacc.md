...
Maintenant parcours les nœuds cibles pour afficher les résultats de chacun.

Ajoute une boucle `for...of` qui itère sur `targets` en utilisant `nodeNo` comme variable de boucle. Laisse le corps vide pour l'instant.

# --hints--

Tu dois créer une boucle `for...of` avec la variable `nodeNo` itérant sur `targets`.
