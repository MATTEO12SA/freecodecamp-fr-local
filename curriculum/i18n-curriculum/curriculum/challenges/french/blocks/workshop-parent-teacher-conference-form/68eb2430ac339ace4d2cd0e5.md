...
Maintenant, tu devrais augmenter la taille de police de tous les éléments `label`.

Sélectionne l'élément `label` et définis son `font-size` sur `1.2rem`.

# --hints--

Tu devrais cibler l'élément `label`.
