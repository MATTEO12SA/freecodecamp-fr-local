...
Pour faire ressortir le conteneur, tu devrais ajouter une propriété `box-shadow` définie sur `0 5px 15px black`.

Cela ajoute un effet d'ombre autour du conteneur. Les valeurs contrôlent respectivement le décalage horizontal, le décalage vertical, le rayon de flou et la couleur.
...
Tu devrais définir la propriété `box-shadow` sur `0 5px 15px black`.
