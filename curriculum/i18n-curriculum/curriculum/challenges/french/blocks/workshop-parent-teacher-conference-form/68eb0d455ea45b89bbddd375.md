...
Maintenant, tu devrais ajouter du remplissage au conteneur. Définis `padding` sur `10px 20px`. Ainsi, tu définis un remplissage de `10px` en haut et en bas, et de `20px` à gauche et à droite.
...
Définis la propriété `padding` sur `10px 20px`.
