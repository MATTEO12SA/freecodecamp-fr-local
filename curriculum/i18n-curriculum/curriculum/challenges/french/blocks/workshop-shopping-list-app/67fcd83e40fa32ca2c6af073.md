...
Maintenant que tu as la structure de base de l'app, il est temps d'ajouter des articles et de faire fonctionner la recherche.

Crée un tableau et assigne-le à une variable nommée `items`. Dans le tableau, ajoute les chaînes `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels`, et `Dish Soap`. Ce sera la liste des articles affichés dans l'app.
...
Ton tableau `items` doit contenir les chaînes `Apples`, `Bananas`, `Strawberries`, `Blueberries`, `Mangoes`, `Pineapple`, `Lettuce`, `Broccoli`, `Paper Towels`, et `Dish Soap`.
