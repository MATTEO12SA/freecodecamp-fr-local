...
Copie les valeurs restantes de gauche dans `array` en assignant `leftPart[leftArrayIndex]` à `array[sortedIndex]`.

# --hints--

Le corps de la boucle doit assigner `leftPart[leftArrayIndex]` à `array[sortedIndex]`.
