...
En dehors de la définition de la fonction, crée un tableau `numbers` avec les valeurs suivantes : `[4, 10, 6, 14, 2, 1, 8, 5]`.

# --hints--

Tu dois créer un tableau appelé `numbers` avec ces valeurs : `[4, 10, 6, 14, 2, 1, 8, 5]`
