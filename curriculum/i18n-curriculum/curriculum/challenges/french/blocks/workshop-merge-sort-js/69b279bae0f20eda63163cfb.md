...
Toujours dans la boucle `while`, incrémente la valeur de `leftArrayIndex` de 1.

# --hints--

Tu dois incrémenter la valeur actuelle de `leftArrayIndex` de `1` après avoir assigné l'élément de la partie gauche au tableau trié.
