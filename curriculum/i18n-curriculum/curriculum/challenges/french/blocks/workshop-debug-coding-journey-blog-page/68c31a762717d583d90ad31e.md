...
Dans la page de blog, il y a au total trois posts de blog enveloppés dans des éléments `div` génériques. Mais il serait préférable d'utiliser des éléments sémantiques pour envelopper chaque post. 

Change chaque élément `div` qui enveloppe un post du blog en un élément `article`.

# --hints--

Ton premier élément `div` pour le premier post devrait être changé en un élément `article`.
...
Ton deuxième élément `div` pour le deuxième post devrait être changé en un élément `article`.
...
Ton troisième élément `div` pour le troisième post devrait être changé en un élément `article`.
