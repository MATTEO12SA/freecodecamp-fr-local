...
Comme la section entière qui contient les posts du blog représente le contenu principal de la page, elle devrait être enveloppée dans un élément `main`. Cela aide les lecteurs d'écran et autres technologies d'assistance à mieux comprendre la structure de la page.
...
Ton élément `main` devrait contenir les trois éléments `article`.
