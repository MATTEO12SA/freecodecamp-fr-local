...
Sous le titre principal de la page, il y a une section de navigation qui contient des liens vers chaque post du blog. 

Cette section devrait être enveloppée dans un élément `nav` pour indiquer son rôle en tant que repère de navigation.

# --hints--

Ta page devrait avoir un élément `nav`.
...
Ton `<h2>Navigation</h2>` devrait être à l'intérieur de l'élément `nav`.
...
Ton élément `ul` devrait être à l'intérieur de l'élément `nav`.
...
Tes éléments `li` devraient être à l'intérieur de l'élément `ul`.
...
Tu ne devrais pas ajouter d'éléments `ul`, `li` ou `h2` supplémentaires.
