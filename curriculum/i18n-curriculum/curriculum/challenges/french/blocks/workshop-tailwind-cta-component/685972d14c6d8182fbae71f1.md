...
Pour que les balises d’ancre ressemblent davantage à des boutons, ajoute les classes `px-4` et `py-2` à chacune. `px-4` augmente le padding gauche et droit de `1rem`, et `py-2` augmente le padding haut et bas de `0.5rem`.

# --hints--

Ton premier élément d’ancre doit avoir la classe utilitaire `px-4`.
...
Ton premier élément d’ancre doit avoir la classe utilitaire `py-2`.
...
Ton second élément d’ancre doit avoir la classe utilitaire `px-4`.
...
Ton second élément d’ancre doit avoir la classe utilitaire `py-2`.
