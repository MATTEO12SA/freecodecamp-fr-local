...
Enfin, les boutons peuvent être mieux espacés entre eux et par rapport au haut. Pour cela, tu dois cibler l’élément `div` qui les enveloppe tous les deux. Ajoute donc les classes `flex`, `gap-2` et `mt-6` à ce `div`.

Avec cela, ton atelier du composant CTA est terminé !

# --hints--

L’élément `div` qui enveloppe les éléments d’ancre doit avoir la classe utilitaire `flex`.
...
L’élément `div` qui enveloppe les éléments d’ancre doit avoir la classe utilitaire `gap-2`.
...
L’élément `div` qui enveloppe les éléments d’ancre doit avoir la classe utilitaire `mt-6`.
