...
Enfin, pour supprimer les bords anguleux de l’élément `div` extérieur, ajoute la classe `rounded-md`.

# --hints--

Ton élément `div` extérieur doit avoir la classe utilitaire `rounded-md`.
