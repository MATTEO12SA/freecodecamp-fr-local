...
Dans le premier point clé, fais pivoter à `110deg`, et conserve la mise à l'échelle du bras gauche.

# --hints--

Tu devrais donner au point clé `10%` un `transform` de `rotate(110deg) scaleX(-1)`.
