...
Pour garder le dégradé linéaire du bon cote du bras gauche du pingouin, fais-le d'abord pivoter de `130deg`, puis inverse l'axe x.

# --hints--

Tu devrais donner à `.arm.left` un `transform` de `rotate(130deg) scaleX(-1)`.
