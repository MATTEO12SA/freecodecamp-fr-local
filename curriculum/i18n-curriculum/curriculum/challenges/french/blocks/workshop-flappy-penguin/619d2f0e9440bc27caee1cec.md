...
Le savais-tu ? La plupart des nageoires, sinon toutes, ne sont pas naturellement des rectangles.

Donne aux coins supérieur gauche, supérieur droit et inférieur droit des éléments `.arm` un rayon de `30%`, et au coin inférieur gauche un rayon de `120%`.

# --hints--

Tu devrais donner à `.arm` un `border-radius` de `30% 30% 30% 120%`.
