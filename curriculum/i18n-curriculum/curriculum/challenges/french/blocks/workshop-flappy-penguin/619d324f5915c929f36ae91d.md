...
Donne à `wave` quatre points clés qui commencent à `10%` et augmentent de `10%`.

# --hints--

Tu devrais ajouter un point clé `10%` pour `@keyframes wave`.
...
Tu devrais ajouter un point clé `20%` pour `@keyframes wave`.
...
Tu devrais ajouter un point clé `30%` pour `@keyframes wave`.
...
Tu devrais ajouter un point clé `40%` pour `@keyframes wave`.
...
Tu devrais avoir 4 points clés dans ton keyframe.
