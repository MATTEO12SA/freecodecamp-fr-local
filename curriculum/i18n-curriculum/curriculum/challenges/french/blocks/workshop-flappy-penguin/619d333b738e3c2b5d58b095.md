...
Dans le deuxième point clé, fais pivoter à `130deg`, et conserve la mise à l'échelle du bras gauche.

# --hints--

Tu devrais donner au point clé `20%` un `transform` de `rotate(130deg) scaleX(-1)`.
