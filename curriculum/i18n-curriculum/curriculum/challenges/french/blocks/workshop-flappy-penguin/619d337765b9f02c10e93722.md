...
Pour les troisième et quatrieme points clés, répète le motif `transform` une fois de plus.

# --hints--

Tu devrais donner au point clé `30%` un `transform` de `rotate(110deg) scaleX(-1)`.
...
Tu devrais donner au point clé `40%` un `transform` de `rotate(130deg) scaleX(-1)`.
