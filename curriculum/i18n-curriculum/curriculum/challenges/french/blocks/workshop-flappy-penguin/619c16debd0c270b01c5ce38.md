...
Fais en sorte que les coins supérieurs des éléments `.face` aient un rayon de `70%`, et que les coins inférieurs aient un rayon de `60%`.

# --hints--

Tu devrais donner à `.face` un `border-radius` de `70% 70% 60% 60%`.
