...
Maintenant, tu dois ajouter un écouteur d'événement sur l'élément `happyBtn`.

Écris l'écouteur d'événement et son callback pour que, quand le bouton est cliqué, l'application affiche dans la console `Button clicked!`.

# --hints--

Quand `happyBtn` est cliqué, `Button clicked!` devrait s'afficher dans la console.
