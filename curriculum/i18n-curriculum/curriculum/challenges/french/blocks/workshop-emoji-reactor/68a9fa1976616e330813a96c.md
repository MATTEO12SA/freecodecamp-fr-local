...
Maintenant, fais de la place : retire toutes les variables de boutons et les `eventListener` que tu as créés pour chacun.

# --hints--

La variable `happyBtn` ne devrait pas exister.
...
La variable `confusedBtn` ne devrait pas exister.
...
La variable `sadBtn` ne devrait pas exister.
...
La variable `lovingBtn` ne devrait pas exister.
