...
Maintenant, remplace le contenu du callback de l'écouteur d'événement.

Utilise `querySelector` pour trouver l'élément `.count` à l'intérieur du bouton.

Ensuite, affiche le contenu texte de l'élément `.count` quand le bouton est cliqué.

# --hints--

Tu devrais afficher le contenu texte de l'élément `.count` à l'intérieur du bouton cliqué.
