...
Il est temps de travailler sur l’élément `div` qui enveloppe les trois cartes de tarification. Pour disposer les cartes, tu peux utiliser les classes utilitaires de grille de Tailwind CSS.

Voici comment assigner un display `grid` à un élément avec Tailwind :
...
Assigne une classe `grid` à l’élément `div` qui enveloppe les cartes de tarification.
