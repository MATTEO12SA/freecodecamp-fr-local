...
Le reste du HTML t’a été fourni. Cela inclut les cartes des plans premium et family. Il est donc temps de styliser les éléments HTML avec Tailwind CSS.

Commence par donner à toute la page un fond légèrement gris en assignant à l’élément `body` la classe `bg-gray-100`.

# --hints--

Ton élément body doit avoir la classe `bg-gray-100`.
