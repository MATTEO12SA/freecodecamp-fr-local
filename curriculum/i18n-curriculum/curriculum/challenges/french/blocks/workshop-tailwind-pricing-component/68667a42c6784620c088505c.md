...
À part le CTA `Go Premium`, le reste du contenu est dans un `div`. Cela fait de CSS grid une bonne option pour tout disposer.

Ajoute les classes `grid`, `grid-rows-[auto_auto_auto_1fr]` et `gap-y-2` au `div` qui enveloppe les éléments `h2`, `p` et `ul`.

# --hints--

Ton élément `div` qui enveloppe les éléments `h2`, `p` et `ul` doit avoir la classe `grid`.
...
Ton élément `div` qui enveloppe les éléments `h2`, `p` et `ul` doit avoir la classe `grid-rows-[auto_auto_auto_1fr]`.
...
Ton élément `div` qui enveloppe les éléments `h2`, `p` et `ul` doit avoir la classe `gap-y-2`.
