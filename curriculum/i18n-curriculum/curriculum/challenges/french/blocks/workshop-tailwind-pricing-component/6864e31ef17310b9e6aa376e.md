...
Les éléments de la grille sont trop proches des bords gauche et droit de la page, donc tu dois travailler sur l’espacement.

Assigne la classe `max-w-6xl` au `div` pour fixer une largeur de `72rem` et empêcher les éléments de s’étirer trop loin sur la page.

Comme cela les poussera tous vers la gauche, ajoute `mx-auto` au `div` pour centrer les éléments horizontalement.

# --hints--

Ton élément `div` doit avoir la classe `max-w-6xl`.
...
Ton élément `div` doit avoir la classe `mx-auto`.
