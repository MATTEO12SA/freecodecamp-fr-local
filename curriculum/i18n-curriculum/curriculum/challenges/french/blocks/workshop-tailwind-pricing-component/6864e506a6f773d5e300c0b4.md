...
À ce stade, les éléments sont trop proches les uns des autres. Ajoute `gap-8` pour créer de l’espace entre eux, et utilise `mt-16` pour les descendre un peu depuis le haut.

# --hints--

Ton élément `div` doit avoir la classe `gap-8`.
...
Ton élément `div` doit avoir la classe `mt-16`.
