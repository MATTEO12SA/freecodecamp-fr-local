...
La carte de tarification suivante est le **plan Premium**.

Donne au `div` enveloppeur du plan premium les classes `bg-gray-950`, `text-white`, `ring-2`, `ring-fuchsia-500` et `p-8`.

# --hints--

Ton élément `div` enveloppeur du plan premium doit avoir la classe `bg-gray-950`.
...
Ton élément `div` enveloppeur du plan premium doit avoir la classe `text-white`.
...
Ton élément `div` enveloppeur du plan premium doit avoir la classe `ring-2`.
...
Ton élément `div` enveloppeur du plan premium doit avoir la classe `ring-fuchsia-500`.
...
Ton élément `div` enveloppeur du plan premium doit avoir la classe `p-8`.
