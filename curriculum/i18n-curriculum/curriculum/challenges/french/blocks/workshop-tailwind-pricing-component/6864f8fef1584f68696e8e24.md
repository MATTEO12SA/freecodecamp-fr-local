...
Maintenant, tu dois passer au CTA `Start listening` pour en faire un vrai bouton.

Assigne-lui les classes utilitaires `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700` et `hover:bg-indigo-200`.

# --hints--

Ton élément d’ancre doit avoir la classe `bg-indigo-100`.
...
Ton élément d’ancre doit avoir la classe `text-indigo-700`.
...
Ton élément d’ancre doit avoir la classe `hover:bg-indigo-200`.
