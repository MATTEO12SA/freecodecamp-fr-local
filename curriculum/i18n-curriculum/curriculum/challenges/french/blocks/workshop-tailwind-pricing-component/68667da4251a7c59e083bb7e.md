...
Pour les éléments `span` à l’intérieur de chaque élément de liste, assigne-leur les classes `text-green-500` et `mr-2` pour rendre les marqueurs verts et les éloigner un peu du texte.

Assigne-leur aussi l’attribut `aria-hidden` comme tu l’as fait pour les éléments `span` du premier plan tarifaire.

# --hints--

Tes éléments `span` doivent avoir la classe `text-green-500`.
...
Tes éléments `span` doivent avoir la classe `mr-2`.
...
Tes éléments `span` doivent avoir l’attribut `aria-hidden`.
