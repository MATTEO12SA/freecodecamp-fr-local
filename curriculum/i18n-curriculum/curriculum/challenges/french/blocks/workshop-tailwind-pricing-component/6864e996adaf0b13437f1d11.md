...
Maintenant, tu dois passer au style des éléments du **plan Listener**.

Donne au `div` extérieur du plan les classes `bg-gray-100`, `ring-1` pour créer un contour épais autour du `div`, et `ring-gray-300` pour donner une couleur sombre à ce contour.

# --hints--

Ton élément `div` doit avoir la classe `bg-gray-100`.
...
Ton élément `div` doit avoir la classe `ring-1`.
...
Ton élément `div` doit avoir la classe `ring-gray-300`.
