...
Vient ensuite le dernier élément de tarification, le **plan Family**.

Pour commencer, donne au `div` enveloppeur du plan les classes `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8` et `rounded-xl`.

# --hints--

Ton élément `div` enveloppeur du plan family doit avoir la classe `bg-gray-100`.
...
Ton élément `div` enveloppeur du plan family doit avoir la classe `ring-1`.
...
Ton élément `div` enveloppeur du plan family doit avoir la classe `ring-gray-300`.
...
Ton élément `div` enveloppeur du plan family doit avoir la classe `p-8`.
...
Ton élément `div` enveloppeur du plan family doit avoir la classe `rounded-xl`.
