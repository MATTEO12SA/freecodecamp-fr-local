...
En passant à l’élément de liste, ajoute les classes `mt-6`, `space-y-2`, `text-sm` et `text-fuchsia-100` au `ul` pour espacer les éléments de liste et les rendre plus attrayants.

# --hints--

Ton élément `ul` doit avoir la classe `mt-6`.
...
Ton élément `ul` doit avoir la classe `space-y-2`.
...
Ton élément `ul` doit avoir la classe `text-sm`.
...
Ton élément `ul` doit avoir la classe `text-fuchsia-100`.
