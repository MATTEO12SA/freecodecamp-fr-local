...
En passant au texte du prix dans le `p` et le `span`, donne à l’élément `p` les classes `text-4xl`, `font-bold` et `text-gray-900` pour que le prix soit plus visible.
