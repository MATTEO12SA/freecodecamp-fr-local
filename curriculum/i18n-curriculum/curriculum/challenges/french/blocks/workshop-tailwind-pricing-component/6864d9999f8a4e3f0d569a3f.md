...
Ensuite, rends le texte du `h1` plus distinct en lui assignant un `class` égal à `text-3xl` pour l’agrandir, `text-center` pour le centrer, `font-semibold` pour le rendre plus gras, `text-gray-900` pour l’assombrir, et `md:text-5xl` pour l’agrandir sur les écrans moyens et plus grands.

# --hints--

Ton élément `h1` doit avoir la classe `text-3xl`.
...
Ton élément `h1` doit avoir la classe `text-center`.
...
Ton élément `h1` doit avoir la classe `font-semibold`.
...
Ton élément `h1` doit avoir la classe `text-gray-900`.
...
Ton élément `h1` doit avoir la classe `md:text-5xl`.
