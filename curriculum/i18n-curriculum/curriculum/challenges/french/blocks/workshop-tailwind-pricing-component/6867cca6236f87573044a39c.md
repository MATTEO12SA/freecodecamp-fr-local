...
La dernière chose que tu vas faire est de styliser le bouton CTA du plan family.

Donne-lui les classes `block`, `rounded-md`, `bg-indigo-600`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-white` et `hover:bg-indigo-700`.

Avec ça, ton atelier de composant de tarification Tailwind est terminé !

# --hints--

Ton élément d’ancre doit avoir la classe `bg-indigo-600`.
...
Ton élément d’ancre doit avoir la classe `px-4`.
...
Ton élément d’ancre doit avoir la classe `py-2`.
...
Ton élément d’ancre doit avoir la classe `text-center`.
...
Ton élément d’ancre doit avoir la classe `font-semibold`.
...
Ton élément d’ancre doit avoir la classe `hover:bg-indigo-700`.
