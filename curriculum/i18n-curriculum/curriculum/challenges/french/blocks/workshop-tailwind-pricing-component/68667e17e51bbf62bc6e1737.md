...
Maintenant, tu dois styliser le CTA pour qu’il ressemble davantage à un bouton.

Pour les couleurs d’arrière-plan et de premier plan, assigne-lui les classes `bg-gradient-to-r`, `from-fuchsia-500`, `to-indigo-600`, `text-white`, `hover:from-fuchsia-600` et `hover:to-indigo-700`. Assigne-lui aussi les classes `rounded-md` et `block`.

# --hints--

Ton élément d’ancre doit avoir la classe `bg-gradient-to-r`.
...
Ton élément d’ancre doit avoir la classe `from-fuchsia-500`.
...
Ton élément d’ancre doit avoir la classe `to-indigo-600`.
...
Ton élément d’ancre doit avoir la classe `text-white`.
...
Ton élément d’ancre doit avoir la classe `hover:from-fuchsia-600`.
...
Ton élément d’ancre doit avoir la classe `hover:to-indigo-700`.
...
Ton élément d’ancre doit avoir la classe `rounded-md`.
...
Ton élément d’ancre doit avoir la classe `block`.
