...
Ajoute les classes `text-4xl`, `font-bold` et `text-white` à l’élément `p` qui contient le texte du prix pour le rendre plus visible.
...
Ton élément `p` doit avoir la classe `text-white`.
