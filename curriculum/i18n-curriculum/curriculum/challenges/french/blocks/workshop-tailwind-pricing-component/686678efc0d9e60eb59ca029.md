...
Le badge peut être mieux stylisé. Pour cela, tu vas utiliser des classes de dégradé Tailwind. Voici comment utiliser les styles de dégradé dans Tailwind :
...
Ajoute les classes `bg-gradient-to-r`, `from-fuchsia-500` et `to-indigo-500` au `div` du badge. Ajoute aussi `rounded-full`, `px-3`, `py-1`, `text-xs`, `font-bold` et `text-white`.

# --hints--

Ton élément `div` avec le texte `Most popular` doit avoir la classe `bg-gradient-to-r`.
...
Ton élément `div` avec le texte `Most popular` doit avoir la classe `from-fuchsia-500`.
...
Ton élément `div` avec le texte `Most popular` doit avoir la classe `to-indigo-500`.
...
Ton élément `div` avec le texte `Most popular` doit avoir la classe `rounded-full`.
...
Ton élément `div` avec le texte `Most popular` doit avoir la classe `px-3`.
...
Ton élément `div` avec le texte `Most popular` doit avoir la classe `py-1`.
...
Ton élément `div` avec le texte `Most popular` doit avoir la classe `text-xs`.
...
Ton élément `div` avec le texte `Most popular` doit avoir la classe `font-bold`.
...
Ton élément `div` avec le texte `Most popular` doit avoir la classe `text-white`.
