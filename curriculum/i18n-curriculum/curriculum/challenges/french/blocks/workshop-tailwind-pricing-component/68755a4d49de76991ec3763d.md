...
Maintenant, assigne au `span` à l’intérieur de l’élément `p` les classes `text-base`, `font-medium` et `text-gray-500`.

# --hints--

Le `span` à l’intérieur de ton élément `p` doit avoir la classe `text-base`.
...
Le `span` à l’intérieur de ton élément `p` doit avoir la classe `font-medium`.
...
Le `span` à l’intérieur de ton élément `p` doit avoir la classe `text-gray-500`.
