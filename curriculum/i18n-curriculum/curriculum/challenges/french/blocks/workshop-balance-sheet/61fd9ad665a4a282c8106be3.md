...
Dans ton `thead`, crée un élément `tr`. Dans celui-ci, ajoute un `td` et trois éléments `th`. Dans chacun des éléments `th`, ajoute un élément `span` avec la `class` définie sur `sr-only` et le texte suivant, dans l'ordre : `2019`, `2020` et `2021`.
