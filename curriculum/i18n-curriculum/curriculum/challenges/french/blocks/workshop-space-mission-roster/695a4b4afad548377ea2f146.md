...
Utilise une boucle `for` pour afficher le `name` de chaque astronaute du tableau `sorted`.

# --hints--

Tu dois utiliser une boucle `for` pour parcourir le tableau `sorted` et afficher le `name` de chaque astronaute.
