...
Trie directement le tableau local `sorted` en utilisant ta fonction utilitaire `sortByPriorityDescending()`.

# --hints--

Tu dois invoquer `sortByPriorityDescending()` avec le tableau `sorted`.
