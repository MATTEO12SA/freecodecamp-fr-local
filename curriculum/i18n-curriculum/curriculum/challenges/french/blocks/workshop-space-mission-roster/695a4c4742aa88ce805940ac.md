...
Pour finaliser la préparation de ta mission spatiale, appelle `printCrewSummary()` avec ton tableau `updatedSquad` !

# --hints--

Tu dois appeler ta fonction `printCrewSummary()` avec `updatedSquad`.
