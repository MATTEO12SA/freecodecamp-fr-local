...
Maintenant, tu peux commencer à construire ta liste. Utilise `addCrewMember()` pour ajouter le `firstAstronaut` à ton `squad`.

# --hints--

Tu dois appeler `addCrewMember()` avec `squad` et `firstAstronaut`.
