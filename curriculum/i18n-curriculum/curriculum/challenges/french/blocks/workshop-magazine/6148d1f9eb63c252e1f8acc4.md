...
Pour donner une couleur au `hr`, tu dois ajuster la propriété `border`. Donne au sélecteur `hr` une propriété `border` définie sur `1px solid rgba(120, 120, 120, 0.6)`.

# --hints--

Ton élément `hr` doit avoir une propriété `border` définie sur `1px solid rgba(120, 120, 120, 0.6)`.
