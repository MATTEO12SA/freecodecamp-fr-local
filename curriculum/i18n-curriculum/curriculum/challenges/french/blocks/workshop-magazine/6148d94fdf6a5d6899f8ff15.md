...
Donne au sélecteur `.text-with-images` une propriété `margin-bottom` définie sur `3rem`.

# --hints--

Ton sélecteur `.text-with-images` doit avoir une propriété `margin-bottom` définie sur `3rem`.
