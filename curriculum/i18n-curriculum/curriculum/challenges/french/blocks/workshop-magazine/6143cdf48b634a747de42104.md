...
Dans ton élément `.image-wrapper`, donne à ton troisième élément `img` un `src` de `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`, un `alt` de `four people working on code`, un attribut `loading` de `lazy`, une `class` définie sur `image-3`, un attribut `width` défini sur `600` et un attribut `height` défini sur `400`.

# --hints--

Ton troisième élément `img` doit avoir le `src` défini sur `https://cdn.freecodecamp.org/testable-projects-fcc/images/survey-form-background.jpeg`.
...
Ton troisième élément `img` doit avoir le `alt` défini sur `four people working on code`.
...
Ton troisième élément `img` doit avoir un attribut `loading` défini sur `lazy`.
...
Ton troisième élément `img` doit avoir la `class` définie sur `image-3`.
...
Ton troisième élément `img` doit avoir un attribut `width` défini sur `600`.
...
Ton troisième élément `img` doit avoir un attribut `height` défini sur `400`.
