...
Pour faire ressortir davantage le texte de la citation, donne au sélecteur `.quote` une propriété `font-family` définie sur `Raleway` avec `sans-serif` comme police de repli.

# --hints--

Ton sélecteur `.quote` doit avoir une propriété `font-family` définie sur `Raleway` avec `sans-serif` comme police de repli.
