...
Crée un sélecteur `h1`, et définis la propriété `font-family` sur `Anton` avec `sans-serif` comme police de repli.
...
Ton sélecteur `h1` doit avoir une propriété `font-family` définie sur `Anton` avec `sans-serif` comme police de repli.
