...
Dans ton élément `.image-wrapper`, donne au deuxième élément `img` un `src` de `https://cdn.freecodecamp.org/testable-projects-fcc/images/calc.png`, un `alt` de `image of a calculator project`, un attribut `loading` défini sur `lazy`, une `class` définie sur `image-2`, un attribut `width` défini sur `400` et un attribut `height` défini sur `400`.

# --hints--

Ton deuxième élément `img` doit avoir le `src` défini sur `https://cdn.freecodecamp.org/testable-projects-fcc/images/calc.png`.
...
Ton deuxième élément `img` doit avoir le `alt` défini sur `image of a calculator project`.
...
Ton deuxième élément `img` doit avoir un attribut `loading` défini sur `lazy`.
...
Ton deuxième élément `img` doit avoir la `class` définie sur `image-2`.
...
Ton deuxième élément `img` doit avoir `width` défini sur `400`.
...
Ton deuxième élément `img` doit avoir `height` défini sur `400`.
