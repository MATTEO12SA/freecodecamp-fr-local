...
Pour basculer la visibilité du texte, tu dois d'abord créer une fonction responsable de ce comportement.

Commence par créer une nouvelle fonction appelée `handleToggleVisibility`.

# --hints--

Tu devrais avoir une fonction `handleToggleVisibility`.
