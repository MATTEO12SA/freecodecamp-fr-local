...
Quand tu sélectionnes une catégorie dans le menu déroulant, les cartes d'instruments sont correctement filtrées et affichées sur la page, mais tu dois te débarrasser de ces virgules entre les cartes.

Fais-le en joignant le tableau renvoyé par `instrumentCards`. Avec cela, ton filtre d'instruments de musique est terminé.
...
Tu devrais joindre le tableau renvoyé par la fonction `instrumentCards`. Ne modifie pas ton écouteur d'événement.
