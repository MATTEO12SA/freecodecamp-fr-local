...
Avant d'ajouter la fonctionnalité de filtre à ta page, lie ton fichier `script.js` au HTML.

# --hints--

Tu devrais avoir un élément `script` avec l'attribut `src` défini à `script.js`.
