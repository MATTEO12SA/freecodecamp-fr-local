...
À l'intérieur de l'élément `form`, ajoute un élément `label`. Ton élément `label` doit avoir le texte `Search for fruits:` et un attribut `htmlFor` avec la valeur `"search-input"`.

# --hints--

Tu dois avoir un élément `label` à l'intérieur de l'élément `form`.
...
L'élément `label` doit avoir un attribut `htmlFor` avec la valeur `"search-input"`.
...
Ton élément `label` doit avoir le texte `Search for fruits:`.
