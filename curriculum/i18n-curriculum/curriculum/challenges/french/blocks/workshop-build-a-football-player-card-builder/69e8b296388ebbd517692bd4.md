...
Ajoute deux autres éléments `div` chacun avec le `className` `form-group` à l’intérieur de `stats-grid`, un pour PAS et l’autre pour DRI.

Pour celui de PAS, ajoute un `label` avec un `htmlFor` `pas` et le texte `PAS`, puis un input avec un `id` `pas` et un `type` `number`.

Et pour celui de DRI, ajoute un `label` avec un `htmlFor` `dri` et le texte `DRI`, puis un input avec un `id` `dri` et un `type` `number`.

# --hints--

Tu dois ajouter deux autres éléments `div` chacun avec le `className` `form-group` à l’intérieur du `div` avec le `className` `stats-grid`.
...
Ton troisième élément `div` avec le `className` `form-group` doit avoir un `label` avec un attribut `htmlFor` `pas`, un `className` `label`, et le texte `PAS`.
...
Ton troisième élément `div` avec le `className` `form-group` doit avoir un `input` avec un `className` `input`, un `id` `pas` et un `type` `number`.
...
Ton quatrième élément `div` avec le `className` `form-group` doit avoir un `label` avec un attribut `htmlFor` `dri`, un `className` `label`, et le texte `DRI`.
...
Ton quatrième élément `div` avec le `className` `form-group` doit avoir un `input` avec un `className` `input`, un `id` `dri` et un `type` `number`.
