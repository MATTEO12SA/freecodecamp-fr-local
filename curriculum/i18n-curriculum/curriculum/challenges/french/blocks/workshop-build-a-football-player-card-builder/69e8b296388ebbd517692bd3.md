...
À l’intérieur de `stats-grid`, ajoute deux éléments `div` chacun avec le `className` `form-group`.

Pour le premier, ajoute un `label` avec le `className` `label`, un `htmlFor` `pac`, et le texte `PAC`, puis un input avec un `id` `pac`, un `className` `input`, et un `type` `number`.

Et pour le second, ajoute un `label` avec un `htmlFor` `sho` et le texte `SHO`, puis un input avec un `id` `sho` et un `type` `number`.

# --hints--

Tu dois avoir deux éléments `div` chacun avec le `className` `form-group` à l’intérieur du `div` avec le `className` `stats-grid`.
...
Ton premier élément `div` avec le `className` `form-group` doit avoir un `label` avec un attribut `htmlFor` `pac`, un `className` `label`, et le texte `PAC`.
...
Ton premier élément `div` avec le `className` `form-group` doit avoir un `input` avec un `className` `input`, un `id` `pac` et un `type` `number`.
...
Ton second élément `div` avec le `className` `form-group` doit avoir un `label` avec un attribut `htmlFor` `sho`, un `className` `label`, et le texte `SHO`.
...
Ton second élément `div` avec le `className` `form-group` doit avoir un `input` avec un `id` `sho`, un `className` `input`, et un `type` `number`.
