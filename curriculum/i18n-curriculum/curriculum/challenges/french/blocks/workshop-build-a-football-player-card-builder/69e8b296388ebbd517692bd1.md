...
Ajoute un autre `div` avec le `className` `form-group`. À l’intérieur, ajoute un élément `label` avec le `className` `label`, un `htmlFor` `imageUrl`, et le texte `Image URL`. Puis ajoute un élément `input` avec un `id` `imageUrl`, un `className` `input`, et un `type` `text`.

# --hints--

Tu dois avoir un élément `div` avec le `className` `form-group`.
...
Ton `div.form-group` doit avoir un `label` avec un attribut `htmlFor` `imageUrl`, un `className` `label`, et le texte `Image URL`.
...
Ton `form-group` Image URL doit contenir un `input` avec un `id` `imageUrl`, un `className` `input`, et un `type` `text`.
