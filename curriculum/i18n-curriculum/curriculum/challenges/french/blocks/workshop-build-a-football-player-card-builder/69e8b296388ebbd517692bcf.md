...
Continue en ajoutant un `div` avec le `className` `form-row`. À l’intérieur, ajoute deux éléments `div` avec chacun le `className` `form-group`.

Le premier élément `div` doit avoir un `label` avec le `className` `label`, un attribut `htmlFor` `position`, le texte `Position`, et un `input` avec l’`id` `position`, un `className` `input` et un `type` `text`.

# --hints--

Ta section Player Info doit contenir un `div` avec le `className` `form-row`.
...
Ton `div.form-row` doit contenir deux éléments `div` chacun avec le `className` `form-group`.
...
Ton premier `form-group` dans la ligne doit avoir un `label` avec le `className` `label` et un `htmlFor` `position`.
...
Ton `label` de position doit avoir le texte `Position`.
...
Ton premier `form-group` dans la ligne doit avoir un `input` avec le `className` `input`, un `id` `position` et un `type` `text`.
