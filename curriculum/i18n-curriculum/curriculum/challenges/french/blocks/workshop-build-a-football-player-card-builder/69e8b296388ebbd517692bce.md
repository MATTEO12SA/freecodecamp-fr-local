...
Ajoute maintenant un `div` avec le `className` `form-group`. À l’intérieur, ajoute un `label` avec le `className` `label` et un attribut `htmlFor` de `name`. En dessous, ajoute un `input` avec un `id` défini à `name`, un `className` `input`, et un attribut `type` `text`.

# --hints--

Tu dois avoir un `div` avec le `className` `form-group`.
...
Ton `form-group` doit contenir un `label` avec le `className` `label` et un attribut `htmlFor` `name`.
...
Ton `form-group` doit contenir un `input` avec un `id` `name`, un `className` `input`, et un `type` `text`.
