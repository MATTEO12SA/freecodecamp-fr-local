...
Enveloppe maintenant le composant `PlayerCard` dans un élément `main` avec le `className` `main`.

À l’intérieur de l’élément `main`, ajoute un `div` avec le `className` `layout`. Dans `layout`, ajoute deux `div` séparés avec le `className` `form-panel` et `preview-panel` respectivement.

# --hints--

Ton `FootballPlayerCard` doit rendre un élément `main` avec le `className` `main` à l’intérieur de `div.page`.
...
Ton `main.main` doit contenir un `div` avec le `className` `layout`.
...
Ton `layout` doit contenir un `div` avec le `className` `form-panel`.
...
Ton `layout` doit contenir un `div` avec le `className` `preview-panel`.
