...
Après le `form-group` DRI, ajoute deux autres éléments `div` chacun avec le `className` `form-group` à l’intérieur de `stats-grid`, un pour DEF et l’autre pour PHY.

Pour celui de DEF, ajoute un `label` avec un `htmlFor` `def` et le texte `DEF`, puis un input avec un `id` `def` et un `type` `number`.

Et pour celui de PHY, ajoute un label avec un `htmlFor` `phy` et le texte `PHY`, puis un input avec un `id` `phy` et un `type` `number`.

# --hints--

Tu dois ajouter un autre ensemble de deux éléments `div` chacun avec le `className` `form-group` à l’intérieur du `div` avec le `className` `stats-grid`.
...
Ton cinquième élément `div` avec le `className` `form-group` doit avoir un `label` avec un attribut `htmlFor` `def`, un `className` `label`, et le texte `DEF`.
...
Ton cinquième élément `div` avec le `className` `form-group` doit avoir un `input` avec un `className` `input`, un `id` `def` et un `type` `number`.
...
Ton sixième élément `div` avec le `className` `form-group` doit avoir un `label` avec un attribut `htmlFor` `phy`, un `className` `label`, et le texte `PHY`.
...
Ton quatrième élément `div` avec le `className` `form-group` doit avoir un `input` avec un `className` `input`, un `id` `phy` et un `type` `number`.
