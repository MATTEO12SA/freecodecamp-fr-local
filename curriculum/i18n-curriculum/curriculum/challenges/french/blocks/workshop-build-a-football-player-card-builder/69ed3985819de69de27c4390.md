...
Mets maintenant à jour `FootballPlayerCard` pour passer `defaultPlayer` à `PlayerCard` au lieu de l’objet en ligne.

# --hints--

Tu dois avoir `defaultPlayer` comme valeur de la prop `player` passée à `PlayerCard`.
